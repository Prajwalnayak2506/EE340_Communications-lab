...
class Part6(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Part6", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Part6")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Part6")
        ...
        self._freq_offset_range = qtgui.Range(0, 10, 0.1, 1, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'out6.txt', False)
...
def main(top_block_cls=Part6, options=None):
