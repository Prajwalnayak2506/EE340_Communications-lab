...
class Part3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Part3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Part3")
        ...
        self._off_range = qtgui.Range(0, 10, 0.1, 0.1, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'out3.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_float*1, 100)
        ...
        self.connect((self.blocks_add_const_vxx_1, 0), (self.blocks_float_to_complex_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.qtgui_const_sink_x_0, 0))
        ...
        self.connect((self.zeromq_pull_source_0, 0), (self.blocks_delay_1, 0))
