...
class Part2b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Part2b", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Part2b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Part2b")
...
def main(top_block_cls=Part2b, options=None):
