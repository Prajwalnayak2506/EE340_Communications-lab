...
class Part5b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Part5b", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Part5b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Part5b")
        ...
        self._freq_offset_range = qtgui.Range(0, 10000, 0.1, 100, 200)
...
def main(top_block_cls=Part5b, options=None):
